...
export function FollowCard({ username, name, isFollowing = false }) {
  ...
  return (
    <article className="x-followCard">
      <img
        ...
        alt={`${name}'s avatar.`}
      />
      <article className="x-followCard-info">
        <strong className="x-followCard-name">
          <p>{name}</p>
          <svg
            className="x-followCard-verified"
            width="20px"
            height="20px"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <p className="x-followCard-username">@{username}</p>
      </article>
      <div className="x-followCard-buttonContainer">
        <button
          className={`x-followCard-button ${following ? "is-following" : ""}`}
          onClick={handleClick}
